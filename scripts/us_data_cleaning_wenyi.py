...
file_path = "american_bankruptcy_dataset_renamed_ratios.csv"  
...
print("\n=== bankrupt value counts ===")
print(df["bankrupt"].value_counts())

# Make sure it is numeric 0/1 and copy to a new column "Bankrupt"
...
# Here we want to winsorize the financial variables, but NOT:
# - the ID-like columns: company_name
# - the target: Bankrupt / bankrupt
# - the industry code: MajorGroup
# - the year: fyear (usually we don't winsorize years)

numeric_cols = df.select_dtypes(include="number").columns.tolist()
exclude_cols = ["Bankrupt", "bankrupt", "MajorGroup", "fyear"]
feature_cols = [c for c in numeric_cols if c not in exclude_cols]

print("\n=== Feature columns to winsorize ===")
print(feature_cols)
...
clean_path = "american_bankruptcy_cleaned_wenyi.csv"
